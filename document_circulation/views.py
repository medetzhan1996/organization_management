...
class WriteFormInHistoryView(LoginRequiredMixin, TemplateResponseMixin, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        url_customer_search_api = 'http://{}/api/customer_personal_cabinet/customer/examination/appointment?insurance={}&iin={}'.format(
            CUSTOMER_CABINET_API_URL,
            CUSTOMER_CABINET_INSURANCE,
            self.customer.iin
        )
        result = requests.get(url_customer_search_api, headers={
            'Authorization': 'Token {}'.format(CUSTOMER_CABINET_API_TOKEN)})
        ...
        url_customer_examination_result = 'http://{}/api/customer_personal_cabinet/customer/examination/result?insurance={}&iin={}'.format(
            CUSTOMER_CABINET_API_URL,
            CUSTOMER_CABINET_INSURANCE,
            self.customer.iin
        )
        ...
        url_package_list_api = 'http://{}/api/customer_personal_cabinet/api/package?insurance={}&iin={}'.format(
            CUSTOMER_CABINET_API_URL, CUSTOMER_CABINET_INSURANCE, self.customer.iin)
